...
module.exports = class Particle {
  constructor (x, y, z, opts) {
    ...
    this.velocity = createVec(this.opts.velocity)
    this.acceleration = createVec(this.opts.acceleration)
    this.trail = []
  }
 ...
 * @return Vec3
 */
function createVec (vec) {
  return Array.isArray(vec) ? new Vec3(vec[0], vec[1], vec[2]) : vec
}
